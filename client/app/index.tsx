...
import { Image, Text, View, TouchableOpacity, StatusBar, StatusBarStyle } from "react-native";
      ...
      <SafeAreaView className="h-full pt-safe">
        <View className="w-full flex justify-between h-full items-center px-6 py-8">
          ...
          <View className="w-full items-center mt-4">
            <Text className="text-green-600 font-intero text-5xl mb-2">AgriVision</Text>
            <Text className="text-green-700/70 font-sfmedium text-base">Plant Health Assistant</Text>
          </View>
          ...
          <View className="w-full items-center">
            ...
            <View className="bg-white/80 rounded-3xl p-6 shadow-sm w-full mt-6">
              <Text className="text-green-600 font-sfbold text-2xl mb-3">
                Detect Plant Diseases Instantly
              </Text>
              <Text className="text-gray-700 font-sfmedium text-base leading-6">
          ...
          <View className="w-full items-center">
            <TouchableOpacity
              className="bg-green-600 w-full rounded-full py-4 shadow-md"
              activeOpacity={0.8}
            >
