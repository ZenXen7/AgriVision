      ...
      <ScrollView className="flex-1">
        <View className="px-6 pt-4 pb-6 bg-green-50">
          ...
          <Text className="text-base font-sfmedium text-gray-600">
            Discover how our AI technology helps you identify and treat lettuce
            diseases
          </Text>
        </View>
        ...
        <View className="px-6 py-8">
          <View className="flex-row mb-12">
            ...
            <View className="flex-1">
              <Text className="text-xl font-sfbold text-green-700 mb-2">
                Take a Photo
              </Text>
              <Text className="text-base font-sfmedium text-gray-600 leading-6">
                Simply snap a clear photo of your lettuce plant using your
                device's camera. Make sure to capture the affected areas
                clearly.
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row mb-12">
            ...
            <View className="flex-1">
              ...
              <Text className="text-base font-sfmedium text-gray-600 leading-6">
                Our deep learning model analyzes the image, identifying patterns
                and symptoms that indicate specific diseases with high accuracy.
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row mb-12">
            ...
            <View className="flex-1">
              ...
              <Text className="text-base font-sfmedium text-gray-600 leading-6">
                Receive instant diagnosis with detailed information about the
                detected disease, including confidence level and visual
                indicators.
              </Text>
            </View>
          </View>
          ...
          <View className="flex-row">
            ...
            <View className="flex-1">
              ...
              <Text className="text-base font-sfmedium text-gray-600 leading-6">
                Follow our expert-backed treatment suggestions to address the
                issue and prevent further spread of the disease.
              </Text>
            </View>
          </View>
        </View>
        ...
        <View className="px-6 py-8 bg-green-50">
          <Text className="text-2xl font-sfbold text-green-700 mb-4">
            Our Technology
          </Text>
          ...
          <View className="bg-white rounded-xl p-5 shadow-sm mb-4">
            <View className="flex-row items-center mb-2">
              ...
              <Text className="text-lg font-sfbold text-green-700 ml-2">
                Computer Vision
              </Text>
            </View>
            <Text className="text-base font-sfmedium text-gray-600">
              Advanced image processing techniques to analyze plant features and
          ...
          <View className="bg-white rounded-xl p-5 shadow-sm mb-4">
            ...
            <Text className="text-base font-sfmedium text-gray-600">
              Neural networks trained on thousands of plant disease images for
          ...
          <View className="bg-white rounded-xl p-5 shadow-sm">
            ...
            <Text className="text-base font-sfmedium text-gray-600">
              Recommendations developed with agricultural scientists and plant
              pathologists.
            </Text>
          </View>
        </View>
